...
local targetName = "veh_slopedTown_4wd_0000"
local targetObjectiveName = "target_slopedTown_4wd"
--Need a four-wheel drive? Check here...
local interSubpId = "enqt1000_1c1110"

this.name="slopedTown_4wd"

this.packs={
    "/Assets/tpp/pack/rng/afgh/op/slopedTown/rng_afgh_slopedTown_4wd.fpk",
}
